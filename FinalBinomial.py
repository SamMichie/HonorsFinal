...
with open('totals.csv', mode='w', newline='') as totals:
    writer1 = csv.writer(totals, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    writer1.writerow(['Total Amount', 'No. of Calls', 'Price Total', 'Gamma Total', 'Delta Total', 'Theta Total', 'Vega Total'])
    writer1.writerow([count, calls, roundPrice, roundGamma, roundDelta, roundTheta, roundVega])
